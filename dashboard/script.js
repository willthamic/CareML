...
var token = "o0eHBc67XXD+bUz8RC1EpkUxO8f3mD/KOLbPTX2UUde3QCYlBVdQyEp2QpSDHCN+0/czGE7DLk3PIhWMHC2oyA==";

  setInterval(function(){
    $.ajax({
             type: "POST",
             url: "https://ussouthcentral.services.azureml.net/workspaces/967dd983ff1f4249b2d1c0f38164b384/services/4c35f726ed7043d7af511f1fe8a85068/execute?api-version=2.0&details=true&format=application/json",
             data: $(json).serialize(),
             success: function() {
                 console.log("success");
             },
